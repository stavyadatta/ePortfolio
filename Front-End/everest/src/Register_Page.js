      ...
      <div className = "register_page">
        ...
        <div className = "register_container">
          ...
          <div className = "register_fields">
            ...
            <EntryBox id = "confirm_password_entry" textType = "password" default = "Confirm Password" onChange = {updateField}/>
            <button id = "register" onClick = {fieldAuthentications}>Register</button>
          </div>
        </div>
      </div>
    );
