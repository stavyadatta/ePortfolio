		...
		<div className = "forms">
			<div className = "login_page">
				...
				<div className = "create_account_container">
					...
					onClick = {animate}>Register</button>
				</div>
...
function ForgotPassword() {
	return (
		...
		callBack = {(e) => {animateComponents(e, "login_fields_container", "forgot_your_password")}} 
...
function RetrievePassword() {
	return(
		<div className = "forgot_your_password">
			...
			callBack = {(e) => {animateComponents(e, "forgot_your_password", "login_fields_container")}} 
			text = "Back to Login"/>
...
function SmallBtn(props) {
	return(
		<button className = "small_btn" id = {props.id} 
