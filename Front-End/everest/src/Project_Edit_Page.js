    ...
    return (
        <div className="projectLayout">
            <div className="projectHeader" style={headerStyle}>
                ...
                <form className={classes.root} noValidate autoComplete="off">
                  <ThemeProvider theme={theme}>
                    <TextField id="title" label="Project Title" defaultValue={project.projectName} color="secondary" variant="filled"/>
                  </ThemeProvider>
                </form>
            ...
            <div className="projectDescription" style={descriptionStyle}>
                ...
                <TextField className={classes.child} id="projectDescriptionEdit" multiline defaultValue={project.projectDesc} InputProps={{
                  classes:{
